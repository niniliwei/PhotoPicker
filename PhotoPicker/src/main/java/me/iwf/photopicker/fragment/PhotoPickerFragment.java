...
public class PhotoPickerFragment extends Fragment {
    ...
    private TextView mOriginSizeTextView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mOriginCheckBox = (CheckBox) rootView.findViewById(R.id.cb_origin);
        mOriginSizeTextView = (TextView) rootView.findViewById(R.id.tv_origin_size);
        mOriginCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    mOriginSizeTextView.setText(formattedSize);
                } else {
                    mOriginSizeTextView.setText("");
                }
            }
        });
...
//        });
        photoGridAdapter.setOnItemCheckListener(new OnItemCheckListener() {
            ...
            public boolean OnItemCheck(int position, Photo path, boolean isCheck, int selectedItemCount) {
                ...
                btPreview.setText(getString(R.string.picker_preview_with_count, total, maxCount));

                return true;
            }

            @Override
            public void onItemCheckComplete(List<String> paths) {
                calculateOriginSize(paths);
            }
        });
     ...
     * @param listener
     */
    public void setPreviewListener(OnClickListener listener) {
        btPreview.setOnClickListener(listener);
    }
    ...
    private void calculateOriginSize(List<String> paths) {
        long sum = 0;
        ...
        formattedSize = sum == 0 ? "" : Formatter.formatFileSize(getActivity(), sum);
        if (mOriginCheckBox.isChecked()) {
            mOriginSizeTextView.setText(formattedSize);
        }
    }
    ...
    public boolean isOrigin() {
        return mOriginCheckBox.isChecked();
    }
